...
import sungjusin.gatag.Update_note;
import sungjusin.gatag.blue_tooth_connect;
import sungjusin.gatag.manual1;
import sungjusin.gatag.personal_information_handling_policy;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "블루투스 연동 기기를 설치해주세요", Toast.LENGTH_LONG).show();
                //Intent intent = new Intent(MainActivity.this, blue_tooth_connect.class);
                //startActivity(intent);
                //mp.stop();
                //finish();
            }
